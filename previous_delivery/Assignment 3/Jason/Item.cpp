...
void Item::equipItem(Item i)
{
	this->chara->equipItem(i);
}

void Item::deEquipItem(string s)
{
	this->chara->deEquipItem(s);
}

void Item::addItemBackpack(Item i)
{
	this->chara->addItemBackpack(i);
}

void Item::removeItemfromBackpack(string s)
{
	this->chara->removeItemfromBackpack(s);
}

void Item::changeAttr(string type, int value, string action)
{
	chara->changeAttr(type, value, action);

}

int Item::modifier(int dice, int bonus) const
{
	return chara->modifier(dice, bonus);
}
...
bool Item::validateNewCharacter()
{
	return chara->validateNewCharacter();
}
...
int Item::getHitPoint() const
{
	return chara->getHitPoint();
}

void Item::setHitPoint(int hitPoint)
{
	chara->setHitPoint(hitPoint);
}

int Item::getArmorClass() const
{
	return chara->getArmorClass();
}

void Item::setArmorClass(int armorClass)
{
	chara->setArmorClass(armorClass);
}

vector<int> Item::getAttackBonus()
{
	return chara->getAttackBonus();
}



void Item::setAttackBonus(const vector<int>& attackBonus)
{
	chara->setAttackBonus(attackBonus);
}

ItemContainer * Item::getCharacterEquipment() const
{
	return chara->getCharacterEquipment();
}

void Item::setCharacterEquipment(ItemContainer * characterEquipment)
{
	chara->setCharacterEquipment(characterEquipment);
}

ItemContainer * Item::getCharacterBackpack() const
{
	return chara->getCharacterBackpack();
}

void Item::setCharacterBackpack(ItemContainer * characterBackpack)
{
	chara->setCharacterBackpack(characterBackpack);
}

CharacterAttr * Item::getCharacterAttr() const
{
	return chara->getCharacterAttr();
}

void Item::setCharacterAttr(CharacterAttr * characterAttr)
{
	chara->setCharacterAttr(characterAttr);
}
